...
%   Copyright 2022-2024 The MathWorks, Inc.
        ...
        function set.DeviceAddress(obj,value)
            switch obj.DeviceName
              case {'AD936x', 'FMCOMMS5', 'E3xx', 'N200/N210/USRP2', ...
                    'N300', 'N310', 'N320/N321', 'X300', 'X310', 'X410', 'E320'}
    ...
    methods(Access=protected)
        ...
        % HVALIDATEUSRPSAMPLERATE function provides the master clock rate and the
        ...
        % factors.
            switch platform
              ...
              case {'N300', 'N310'}
                ...
                factor = [1:4 6:2:128 130:2:256 260:4:512 520:8:1016];
              ...
              case {'X300', 'X310'}
                ...
                factor = [1:128 130:2:256 260:4:512 512:8:1016];

              case {'X410'}
                masterClockRate = [245.76e6 250e6];
                factor = [1:128 130:2:256 260:4:512 512:8:1016];

              case {'E320'}
                masterClockRate = [40e6 50e6 61.44e6];
                factor = [1:128 130:2:256 260:4:512 512:8:1016];
